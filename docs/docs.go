...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/deployment-templates/{id}/history": {
            "get": {
        ...
        "/api/deployment-templates/{id}/repos": {
            "get": {
        ...
        "/api/deployment-templates/{id}/repos/{repoId}": {
            "post": {
        ...
        "/api/templates/{templateId}/repos/{repoId}": {
            "post": {
